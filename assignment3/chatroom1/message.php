...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        function updateChat(xmlDoc) {
            ...
            for(var i = lastMsgID;i<messages.length;i++)
            {
				...
				var nameStr = message.getAttribute("name");
				var color = message.getAttribute("color");
                var contentStr = message.firstChild.nodeValue;
        ...
        function showMessage(nameStr, contentStr,color){
                ...
                var conetentNode = document.createElementNS("http://www.w3.org/2000/svg", "div");
				conetentNode.setAttribute("fill", color);
                // Set the attributes and create the text
                conetentNode.setAttribute("x", 200);
			    // add Hyper Link
				contentStr = addHyperLink(contentStr);
    ...
    <svg width="800px" height="2000px" id = "svg_doc"
